...
const News = () => {
  ...
  const styles = {
    viewMoreWrapper: "flex items-center mt-2",
    filterHover: "text-accent text-lg pr-1 hover:pr-2 ease-out duration-300 cursor-pointer hover:text-accent-dark hover:font-semibold",
  };
  return (
    <div className="p-8">
      <Card className="w-30 p-2 mb-5 hover:bg-slate-100">
          ...
          <div className="flex flex-col ml-4">
            ...
            <CardContent className="text-xl" style={{ display: "flow" }}>
              ...
              <div className={styles.viewMoreWrapper}>
                <span className={styles.filterHover}>Xem thêm</span>
      ...
      <section className="grid grid-cols-3 gap-4">
        <Card className="w-300 hover:bg-slate-100">
          ...
          <CardContent style={{ display: "flow" }}>
            ...
            <div onClick={() => navigate('/news/mockup-news')} className={styles.viewMoreWrapper}>
              <span className={styles.filterHover}>Xem thêm</span>
              <ArrowRight className='text-accent' />
            </div>
          </CardContent>
        ...
        <Card className="w-300 hover:bg-slate-100" onClick={() => navigate("/school/9")}>
        ...
        <Card className="w-300 hover:bg-slate-100" onClick={() => navigate("/school/6")}>
