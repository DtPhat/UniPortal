...
const Ranking = () => {
  ...
  return (
    <div className="shadow-md my-4 border-2 rounded-lg overflow-hidden ">
      <div className="flex flex-col items-center text-black justify-center p-4 shadow-md bg-slate-50/50">
        <Form {...form}>
          <form className="flex flex-col items-center text-black justify-center p-4 shadow-md bg-slate-50/50 w-full" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="w-full italic">
              ...
              <Button className="text-accent px-2" variant="ghost">
              ...
              {data.data?.studentRecords ? (
                <>
                  {data.data?.studentRecords.map((record) => (
                    // <div key={record.id} className="flex font-bold justify-between">
                    //   <div className="col-span-4">
                    //     <label key={record.subject.id}>{record.subject.name}:</label>
                    //   </div>
                    //   <div className="col-span-8">
                    //     <Input placeholder="0.0" defaultValue={record.mark} />
                    //   </div>
                    // </div>
                    <FormField
                      key={record.id}
